    ...
    <>
      ...
      <div className="search-results">
        <div className="container">
          <div className="flex">
            <svg onClick={hideSearch} xmlns="http://www.w3.org/2000/svg" className="icon-button -ml-2 closer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            </svg>
            <div className="w-full">
              <input type="text" placeholder="Type to search" className="mt-1 py-1 w-full outline-none" value={search} onChange={doSearch} />
