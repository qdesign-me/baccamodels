    ...
    <div>
      ...
      {quickView && (
        <>
          ...
          <div class="fixed shadow-lg bg-white max-w-md w-full sm:p-6 lg:p-8 top-0 bottom-0 right-0 h-screen z-10">
            <div class="relative">
              ...
              <div className="flex items-center mb-4">
                <img class="h-16 w-16 rounded-full mr-4" src={quickView.img} alt="" />
